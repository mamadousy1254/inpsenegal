        ...
        <div className="max-w-7xl mx-auto px-6 space-y-8">
          <div className="flex items-center gap-3 max-w-xl">
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-[#DCC8A8] bg-white text-gray-800 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#C9A574] focus:border-transparent transition"
            />
          </div>

          <div className="flex items-center gap-4 flex-wrap">
            <Calendar className="h-5 w-5 text-[#7B4F2A]" />
            {years.map((year) => (
              <button
                key={year}
                type="button"
            ...
            <span className="ml-auto text-sm text-gray-500">
              <span className="font-semibold text-[#7B4F2A]">{filteredArchives.length}</span>{" "}
                ...
                >
                  ...
                  <div className="p-8 space-y-5">
                    ...
                    <div className="flex items-start gap-3">
                      <FileText className="h-5 w-5 text-[#7B4F2A] mt-0.5 flex-shrink-0" />
