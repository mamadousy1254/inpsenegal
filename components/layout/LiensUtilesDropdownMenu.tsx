...
interface LiensUtilesDropdownMenuProps {
    open: boolean;
    onClose: () => void;
}
...
export function LiensUtilesDropdownMenu({ open, onClose }: LiensUtilesDropdownMenuProps) {
                ...
                >
                            ...
                            {LIENS_UTILES.map((item) => (
                                <li key={item.url} className="w-full">
                                    <a
                                        ...
                                        onClick={onClose}
                                        className={`
                      group relative flex items-center justify-between w-full px-4 py-3 text-[14px] font-semibold transition-all duration-300 rounded-lg border
                    ...
                    `}
                                    >
                                        ...
                                        <ExternalLink className="h-3.5 w-3.5 opacity-40 group-hover:opacity-100 transition relative z-[1]" />
                                    </a>
                                </li>
                            ))}
                        </ul>
