      ...
      <div className="bg-white border-b border-[#E5DCC2]">
        <div className="container mx-auto px-4 py-8 max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
            ...
            <form className="md:col-span-2 flex flex-col sm:flex-row gap-2">
              <input
                type="email"
                placeholder="votre@email.sn"
                className="flex-1 px-4 py-2.5 border border-[#E5DCC2] rounded-full focus:border-[#7B4F2A] focus:outline-none focus:ring-2 focus:ring-[#7B4F2A]/20 text-sm"
                aria-label="Votre adresse email"
              />
              <button
                type="submit"
                className="bg-[#7B4F2A] hover:bg-[#4A2F1A] text-white font-semibold px-6 py-2.5 rounded-full text-sm transition-colors whitespace-nowrap"
              >
                S&apos;inscrire ↗
              </button>
            </form>
